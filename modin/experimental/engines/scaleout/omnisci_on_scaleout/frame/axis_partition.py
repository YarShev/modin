...
class OmnisciOnScaleoutFrameAxisPartition(PandasFrameAxisPartition):
    ...
    partition_type = OmnisciOnScaleoutFramePartition


class OmnisciOnScaleoutFrameColumnPartition(OmnisciOnScaleoutFrameAxisPartition):
...
class OmnisciOnScaleoutFrameRowPartition(OmnisciOnScaleoutFrameAxisPartition):
