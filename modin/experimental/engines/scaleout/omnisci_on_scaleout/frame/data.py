...
from .partition_manager import OmnisciOnScaleoutFramePartitionManager
...
class OmnisciOnScaleoutFrame(PandasFrame):

    _query_compiler_cls = DFAlgQueryCompiler
    _partition_mgr_cls = OmnisciOnScaleoutFramePartitionManager
    ...
    def _set_index(self, new_index):
        if not isinstance(new_index, (Index, MultiIndex)):
            raise NotImplementedError(
                "OmnisciOnScaleoutFrame._set_index is not yet suported"
            )
    ...
    def _get_columns(self):
        return super(OmnisciOnScaleoutFrame, self)._get_columns()
