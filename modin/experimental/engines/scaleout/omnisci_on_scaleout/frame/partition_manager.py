...
from .axis_partition import (
    ...
    OmnisciOnScaleoutFrameRowPartition,
)
from .partition import OmnisciOnScaleoutFramePartition
...
class OmnisciOnScaleoutFrameManager(ScaleoutFrameManager):
    ...
    _column_partitions_class = OmnisciOnScaleoutFrameColumnPartition
    _row_partition_class = OmnisciOnScaleoutFrameRowPartition
        ...
        for frame in frames:
            if frame._partitions.size != 1:
                raise NotImplementedError(
                    "OmnisciOnScaleout engine doesn't support partitioned frames"
                )
